...
const Skills = () => {
  ...
  return (
    <div className="mt-32 main" id='skills' ref={ref}>
      ...
      <div className='flex justify-around mt-24 education1' >
        <div className="max-w-sm rounded overflow-hidden shadow-lg div">
          ...
          <div className=' skill1 skill3 border rounded h-12 font-extrabold flex justify-between mt-5'>
            <div className='mt-2'>
              <span className='m-2 font-extrabold text-black'>Python</span>
            </div>
            <div className='mt-2'>
              <span className='m-2 '>65%</span>
            </div>
          </div>
          <div className=' skill1 skill3 border rounded h-12 font-extrabold flex justify-between mt-5'>
            <div className='mt-2'>
              <span className='m-2 font-extrabold text-black'>C language</span>
            </div>
            <div className='mt-2'>
              <span className='m-2 '>45%</span>
            </div>
          </div>
        </div>
        <div className="max-w-sm rounded overflow-hidden shadow-lg div">
          <h1 className='text-center font-extrabold text-black text-3xl'>About Me</h1>
